...
exports.rpcDataToBuffer = exports.bufferToRpcData = exports.rpcDataToBN = exports.rpcDataToNumber = exports.numberToRpcStorageSlot = exports.numberToRpcQuantity = exports.rpcQuantityToBN = exports.rpcQuantityToNumber = exports.rpcFloat = exports.rpcQuantityAsNumber = exports.rpcUnsignedInteger = exports.rpcAddress = exports.rpcStorageSlot = exports.rpcHash = exports.rpcData = exports.rpcQuantity = void 0;
...
exports.rpcStorageSlot = new t.Type("Storage slot", ethereumjs_util_1.BN.isBN, validateStorageSlot, t.identity);
function validateStorageSlot(u, c) {
    ...
    if (u.match(/^0x(?:[0-9a-fA-F]*)*$/) === null) {
        return t.failure(u, c, `Storage slot argument must be a valid hexadecimal prefixed with "0x", got '${u}'`);
    }
    if (u.length !== 66) {
        // return t.failure(
        //   u,
    ...
    return t.success(new ethereumjs_util_1.BN((0, ethereumjs_util_1.toBuffer)(u)));
}
